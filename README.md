...
| Dash | Space / Shift | Tap right side |
| Pause | Escape / P | — |
| Mute | M | — |
...
- **Stunning Visuals** — Neon-lit industrial aesthetic with particles, screen shake, glow effects, and CRT scanlines

## 🏗️ Technical

- **Pure HTML5 Canvas + Vanilla JavaScript** — Zero dependencies
- **Procedural Graphics** — All visuals rendered on canvas (no sprite sheets)
- **Procedural Audio** — Web Audio API for SFX and layered background music
- **Responsive** — Works on desktop and mobile
- **Local Storage** — High scores and upgrades persist between sessions
...
- **Audio** ⭐ — Fully procedural soundtrack that responds to gameplay
...
MIT — Open Source for the Game Jam
